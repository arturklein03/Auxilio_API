...
--
-- Host: 127.0.0.1
-- Tempo de geração: 24-Set-2022 às 23:34
...
CREATE TABLE `cidades` (
  `codigoCidade` int(7) DEFAULT NULL,
  `nomeCidade` varchar(32) DEFAULT NULL
...
INSERT INTO `cidades` (`codigoCidade`, `nomeCidade`) VALUES
